...
<body>
	...
	$(function() {
		...
		{ 
			...
			output: '<span class="gray">+++Server is maintenance</><br>&nbsp;',
			postDelay: 1000
		},
		{ 
			action: 'type',
			strings: ["Maybe this is not what you are looking for. ", 'But sorry this page is being repaired or maintenance. If something goes wrong, please report this error to the administrator or go back and forget about the thing here ...'],
			postDelay: 2000
		}
